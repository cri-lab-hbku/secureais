// ais_recvr.cpp: Ahmed Aziz
// Description: A program for implementing the proposed AIS Security Protocol
// v0 - Beta
//g++ testallMyTest.cpp core.a -o main
...
int main(void)
{
    ...
    for(message_count = 0; message_count < 1; message_count++) {
